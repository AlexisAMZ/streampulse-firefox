/* GÉNÉRÉ par scripts/build-inline-points-bonus.mjs. Ne pas éditer à la main.
...
const CHEST_PATH = "M13 12h-2v2h2v-2Z";
...
function pickBonusChest(buttons) {
  return (buttons || []).findIndex(isBonusChest);
}

  window.__SP_POINTS_BONUS__ = {
    CHEST_PATH,
    isBonusChest,
    pickBonusChest,
  };
